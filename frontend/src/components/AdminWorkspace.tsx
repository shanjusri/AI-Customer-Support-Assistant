...
export function AdminWorkspace() {
  ...
  const loadAdminState = async () => {
    try {
      const tRes = await fetch("https://ai-customer-support-assistant-d4br.onrender.com/api/ticket");
      const kRes = await fetch("https://ai-customer-support-assistant-d4br.onrender.com/api/knowledge");
      const aRes = await fetch("https://ai-customer-support-assistant-d4br.onrender.com/api/analytics");
  ...
  const handleAdminLogin = async (e: React.FormEvent) => {
    ...
    setAuthError("");
    try {
      const res = await fetch("https://ai-customer-support-assistant-d4br.onrender.com/api/login", {
        method: "POST",
  ...
  const handleCreateKnowledgeArticle = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch("https://ai-customer-support-assistant-d4br.onrender.com/api/knowledge", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          title: newTitle,
